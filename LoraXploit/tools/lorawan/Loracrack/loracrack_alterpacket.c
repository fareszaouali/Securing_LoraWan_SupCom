...
#include <openssl/evp.h>  // Ensure that EVP functions are available
#include <openssl/aes.h>  // Ensure that AES functions are available
...
int main (int argc, char **argv)
{
        ...
        // Cipher vars
        EVP_CIPHER_CTX *ctx_aes128 = EVP_CIPHER_CTX_new();  // Allocate context dynamically using EVP_CIPHER_CTX_new()
