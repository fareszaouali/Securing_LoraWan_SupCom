...
def processData():
    ...
    packet_count = Packet.rows_quantity()
    if packet_count is None:
        logging.error("Packet.rows_quantity() returned None. No packets found or DB error.")
        return
    ...
    while keep_iterating:
        ...
        if options.to_id is None:
            ...
            if (start_packet_id + 2*PACKETS_BATCH) <= packet_count:
